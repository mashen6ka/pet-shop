...
ALTER TABLE "worker" ADD FOREIGN KEY ("shop_point_id") REFERENCES "shop_point" ("id");
...
ALTER TABLE "order" ADD FOREIGN KEY ("shop_point_id") REFERENCES "shop_point" ("id");
